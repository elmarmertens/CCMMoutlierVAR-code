%% Estimates quasi-real-time runs of VAR-SV-AR(1)-OutMiss model
...
labelSampling = strcat(labelSampling, sprintf('-SVar1nanO%d', Ofactor));
...
parfor ndxT = 1 : Njumpoffs % parfor
    ...
    while ~OK
        try
            ...
            [PAI_all, PHI_all, invA_all, SVrho_all, sqrtht_all, Ydatadraws_all, Ynan,...
                ydraws, yhat, yhatRB, ~, ydraws2, yhat2, logscoredraws, logscoreNaNdraws] ...
                = mcmcVARSVar1nanOutlier(thisT, MCMCdraws, Ofactor, p, np, thisdata, ydates, ...

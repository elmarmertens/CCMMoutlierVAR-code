function [PAI_all, PHI_all, invA_all, sqrtht_all, ...
    ...
    SVtscalelog2_all, ...
    fcstYdraws, fcstYhat, fcstYhatRB, fcstSVdraws, fcstSVoutliers] = mcmcVARSVOtdof(thisT, MCMCdraws, p, np, data0, ydates0, ...
...
while m < MCMCreps % using while, not for loop to allow going back in MCMC chain
    ...
    [Vol_states, ~, eta,  sqrtht, SVOlog2, SVOprob, SVOscale, SVtscalelog2] = ...
        StochVolOutliertdof(yresid2', logyresid2', Vol_states, sqrtPHI_, Vol_0mean, Vol_0vcvsqrt, SVOlog2, SVOprob, SVOalpha, SVObeta, SVOstates, ...

function [PAI_all, PHI_all, invA_all, sqrtht_all, ...
    ...
    fcstYdraws, fcstYhat, fcstYhatRB, fcstSVdraws, fcstSVoutliers] = mcmcVARSVO(thisT, MCMCdraws, p, np, data0, ydates0, ...
...
while m < MCMCreps % using while, not for loop to allow going back in MCMC chain
    ...
    if m > burnin;
        ...
        for nn = 1 : Ndraws
            ...
            fcstSVdraws(:,:,nn,thisdraw)    = outlierSV .* exp(logSV * 0.5);

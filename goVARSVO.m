%% Estimates quasi-real-time runs of VAR-SVO model
...
labelSampling = strcat(labelSampling, '-SVO', sprintf('max%d', SVOmaxscale));
...
parfor ndxT = 1 : Njumpoffs % parfor
    ...
    [PAI_all, PHI_all, invA_all, sqrtht_all, ...
        ...
        = mcmcVARSVO(thisT, MCMCdraws, p, np, thisdata, ydates, ...

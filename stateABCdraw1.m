function Xdraws = stateABCdraw1(A, B, C, Ydata, yNaNndx, X0, sqrtSigma, rndStream)
% STATEABCDRAW
% ....
...
Ytilde                      = zeros(Ny, T);
Yplustilde                  = zeros(Ny, T);
[XtT, Xttm1]                = deal(zeros(Nx, T));
[Xplus, XplustT, Xplusttm1] = deal(zeros(Nx, T));

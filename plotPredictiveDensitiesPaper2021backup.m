...
if doRow3
    ...
    close all
    thisPlotLabel = 'predictiveDensityOutmiss';
    for n = ylist
...
if doCompareSVt
    close all
    thisPlotLabel = 'predictiveDensitySVtdof';
    for n = ylist
        ...
        for ndxT = ndxRange
            ...
            set(ax, 'fontsize', fontsize)
            hold on
            hanni(1)   = plotCIaltcolor(fcstMidSVt(n,:,ndxT), squeeze(fcstTailsSVt(n,:,:,ndxT)), ...
                theseFcstdates, [], 'b-', 'linewidth', 3);
            
            hanni(2)   = plot(theseFcstdates,fcstMidSVtdof(n,:,ndxT), 'k-.', 'linewidth', 3);
            plot(theseFcstdates,squeeze(fcstTailsSVtdof(n,:,:,ndxT)), 'k-.', 'linewidth', 2);
            ...
            hl = legend(hanni, prettylabelSVt, prettylabelSVtdof, ...
                'location', 'best');
            wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHTITLELEGEND', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
            ...
            hl = legend([hanni; hd], prettylabelSVt, prettylabelSVtdof, 'realized', ...
                'location', 'best');
            wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHLEGENDDATA', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
...
%% plot SVOt vs SVOtdof
if doCompareSVOt
    close all
    thisPlotLabel = 'predictiveDensitySVOtdof';
    for n = ylist
        ...
        for ndxT = ndxRange
            ...
            hanni(2)   = plot(theseFcstdates,fcstMidSVOtdof(n,:,ndxT), 'k-.', 'linewidth', 3);
            plot(theseFcstdates,squeeze(fcstTailsSVOtdof(n,:,:,ndxT)), 'k-.', 'linewidth', 2);
            ...
            plot(theseJumpoffdates, data(jj+(-np:0),n), '-', 'color', darkgreen, 'linewidth', 2);
            if doConnectDots
                plot([theseJumpoffdates(end) theseFcstdates(1)], [data(jj,n) fcstMidSVOt(n,1,ndxT)], ':', 'color', black, 'linewidth', 2);
            end
            ...
            hl = legend(hanni, prettylabelSVOt, prettylabelSVOtdof, ...
                'location', 'best');
            wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHTITLELEGEND', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
            ...
            hl = legend([hanni; hd], prettylabelSVOt, prettylabelSVOtdof, 'realized', ...
                'location', 'best');
            wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHLEGENDDATA', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)

...
for n = ylist
    ...
    for ndxT = ndxRange
        ...
        delete(hanni(3))
        delete(h3tail)
        wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHTITLE-roll2', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
        delete(hanni(2))
        delete(h2tail)
        wrapthisfigure(thisfig, sprintf('%s-%s-%s-WITHTITLE-roll1', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
        ...
        delete(hanni(3))
        delete(h3tail)
        wrapthisfigure(thisfig, sprintf('%s-%s-%s-roll2', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)
        delete(hanni(2))
        delete(h2tail)
        wrapthisfigure(thisfig, sprintf('%s-%s-%s-roll1', thisPlotLabel, ncode{n}, datestr(thisdateT, 28)), wrap, [], [], [], [], true)

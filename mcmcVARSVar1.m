function [PAI_all, PHI_all, invA_all, SVrho_all, sqrtht_all, ...
    fcstYdraws, fcstYhat, fcstYhatRB, fcstSVdraws, fcstLogscoreDraws] = mcmcVARSVar1(thisT, MCMCdraws, p, np, data0, ydates0, ...
...
% hrho0         = repmat(0.95, N, 1);
% iVhrho0       = diag(1 ./ repmat(0.3^2, N, 1)); 
...
while m < MCMCreps % using while, not for loop to allow going back in MCMC chain
    ...
    [Vol_states, Vol_mean, Vol_dev] = ...
        StochVolAR1(logy2', Vol_states, hrho, sqrtPHI_, Vol_0mean, Vol_0vcvsqrt, ...

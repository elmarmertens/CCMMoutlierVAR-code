%% Estimates quasi-real-time runs of VAR-SVO-t model
...
labelSampling = strcat(labelSampling, '-SVOt', sprintf('max%d', SVOmaxscale));
...
parfor ndxT = 1 : Njumpoffs % parfor
    ...
    [PAI_all, PHI_all, invA_all, sqrtht_all, ...
        ...
        = mcmcVARSVOt(thisT, MCMCdraws, p, np, thisdata, ydates, ...

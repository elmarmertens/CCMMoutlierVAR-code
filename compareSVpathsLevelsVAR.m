...
for ndxT = find(ydates(Tjumpoffs) == datenum(2021,3,1)) 
    ...
    for n = ylist
        ...
        wrapthisfigure(svfig, sprintf('stochvol-levels-SV-%s-%s', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], true);
        wrapthisfigure(svtfig, sprintf('stochvol-levels-SVt-%s-%s', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], true);
        wrapthisfigure(svotfig, sprintf('stochvol-levels-SVOt-%s-%s', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], true);
        wrapthisfigure(svofig, sprintf('stochvol-levels-SVO-%s-%s', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], true);
        ...
        wrapthisfigure(svfig, sprintf('stochvol-levels-SV-%s-%s-WITHTITLE', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], false);
        wrapthisfigure(svtfig, sprintf('stochvol-levels-SVt-%s-%s-WITHTITLE', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], false);
        wrapthisfigure(svotfig, sprintf('stochvol-levels-SVOt-%s-%s-WITHTITLE', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], false);
        wrapthisfigure(svofig, sprintf('stochvol-levels-SVO-%s-%s-WITHTITLE', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], false);
        
        delete(ht)
        legend(axSVOt, 'Total', 'Persistent SV', 'location', 'best')
        wrapthisfigure(svotfig, sprintf('stochvol-levels-SVOt-%s-%s-WITHLEGEND', ncode{n}, datestr(ydates(thisT), 'mmmyyyy')), wrap, [], [], [], [], true);

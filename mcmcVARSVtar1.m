function [PAI_all, PHI_all, invA_all, SVrho_all, sqrtht_all, ...
    ...
    fcstYdraws, fcstYhat, fcstYhatRB, fcstSVdraws, fcstLogscoreDraws] = mcmcVARSVtar1(thisT, MCMCdraws, p, np, data0, ydates0, ...
...
while m < MCMCreps % using while, not for loop to allow going back in MCMC chain
    ...
    [Vol_states, Vol_mean, Vol_dev, ~,  sqrtht, SVtscalelog2, SVtdof] = ...
        StochVoltAR1(yresid2', logyresid2', Vol_states, hrho, sqrtPHI_, Vol_0mean, Vol_0vcvsqrt, ...
